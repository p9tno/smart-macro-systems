...
<div class="homeExamples__item">
    <div class="homeExamples__img img br"><?php echo $img; ?></div>
    <div class="homeExamples__content">
        <a href="<?php the_permalink(); ?>" class="homeExamples__title"><?php the_title(); ?></a>
        <div class="homeExamples__text"><?php the_excerpt_max_charlength(150); ?></div>
    </div>
</div>
